  ...
  return (
    <div className="admin-page">
      <div className="admin-hero">
        <h1 className="admin-hero-title">Financial Intelligence</h1>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '24px' }}>
        ...
        <Col xs={24} lg={12}>
          <CustomCard title={<span style={{ color: colors.text.primary }}>Weekly Earnings Timeline</span>} style={{ height: '100%' }}>
        ...
        <Col xs={24} lg={12}>
          <CustomCard title={<span style={{ color: colors.text.primary }}>Revenue Source Distribution</span>} style={{ height: '100%' }}>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '24px' }}>
        ...
        <Col xs={24} lg={12}>
          <CustomCard title={<span style={{ color: colors.text.primary }}>Subscriber Segmentation</span>} style={{ height: '100%' }}>
                ...
                <Space direction="vertical" style={{ width: '100%', paddingLeft: '12px' }} size="large">
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <Text strong style={{ color: colors.text.tertiary, fontSize: '13px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>PREMIUM SUBSCRIBERS</Text>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <Text strong style={{ color: colors.text.tertiary, fontSize: '13px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>FREE TIER USERS</Text>
        ...
        <Col xs={24} lg={12}>
          <CustomCard title={<span style={{ color: colors.text.primary }}>Transaction Reliability</span>} style={{ height: '100%' }}>
            <Row gutter={16}>
...
const MetricCard = ({ title, value, color, prefix, trend, isCurrency = true }: any) => (
  <CustomCard hoverable style={{ height: '100%', borderRadius: '16px', border: `1px solid ${colors.gray[100]}`, boxShadow: shadows.sm }}>
    ...
    <div style={{
      ...
      <Text style={{ fontSize: '12px', color: colors.text.tertiary, fontWeight: 600 }}>Overview Statistics</Text>
