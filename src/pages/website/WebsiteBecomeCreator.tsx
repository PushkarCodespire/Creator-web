...
import styles from './WebsiteBecomeCreator.module.css';
import {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fbf7f4' }}>
      ...
      <section className={styles.inviteBanner}>
        <div style={{ maxWidth: 1229, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, textAlign: 'center' }}>
          <h2 className={styles.inviteTitle}>
            <span style={{ fontSize: 20, lineHeight: 1, color: '#ffffff' }}>✦</span>
            Invite Only Early Access
          </h2>
          <p className={styles.inviteSub} style={{
            fontWeight: 400,
          ...
          <div style={{
            ...
            {FOUNDING_FEATURES.map((f, i) => (
              <div
                ...
                style={{ borderBottom: i < FOUNDING_FEATURES.length - 1 ? '1px solid #ede8e2' : 'none' }}
              >
                {/* ── Number ── */}
                <div className={styles.tableNumber} style={{ fontFamily: '-apple-system, "SF Pro Display", "Inter", system-ui, sans-serif' }}>
                  {f.num}
                </div>
                ...
                {/* ── Preview widget (hidden on mobile) ── */}
                <div className={styles.tablePreview}><FeaturePreview type={f.preview} /></div>
            ...
            <div className={styles.tableFooter}>
              ...
              <div className={styles.tableTotal}>₹2,82,000 +</div>
            </div>
      ...
      <section className={styles.storiesSection}>
        <div style={{ maxWidth: 1229, margin: '0 auto' }}>
          <h2 className={styles.storiesTitle}>Creator stories</h2>
          <p className={styles.storiesSub}>The people doing the work.</p>
          <div className={styles.storiesGrid}>
            {CREATOR_STORIES.map((c) => (
              <div key={c.name} className={styles.storyCard}>
                <img
                  src={c.gradient}
                  alt=""
                  aria-hidden
